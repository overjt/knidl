...
### M34 `0x080B6154-0x080B9D0B` - save file / SRAM records + options - **landed (#94, partial: 92/105)**

* **Decompiled** into `src/save_b6a90.c`, `save_b6e44.c`, `save_b77d4.c`,
  `save_b63a4.c`, `save_b6c40.c`, `save_b7a9c.c`, `save_b7df4.c`,
  `save_b7e14.c`, `save_b8888.c`, `save_b8918.c`, `save_b8ea0.c` (92 of 105
...
* **13 functions remain in asm**: `sub_080b6154`, `sub_080b6290`,
  `sub_080b6474`, `sub_080b6570`, `sub_080b67dc`, `sub_080b6b08`,
  `sub_080b6d04`, `sub_080b6f38`, `sub_080b72bc`, `sub_080b75a4`,
  `sub_080b76a8`, `sub_080b79b8`, `sub_080b8694` (see #94 for the per-function
  residue).  Six of them are the four-loop HBlank family of 3.336 and its two
