...
/*
 * GBA I/O register map (0x04000000 block), issue #27.
 *
 * Complete register set ported after pret (pokeemerald include/gba/io_reg.h),
 * which follows GBATEK.  Every address the ROM touches is covered
 * (docs/analysis/rom-map.md §4: DISPCNT, DISPSTAT/VCOUNT, BGxCNT/scroll,
 * sound registers at 0x04000080+, timers, DMA, KEYINPUT, the interrupt
 * block IE/IF/IME at 0x04000200+, and WAITCNT at 0x04000204).
 *
 * Conventions (docs/header-conventions.md):
 *   - REG_OFFSET_<NAME>  byte offset from REG_BASE
 *   - REG_ADDR_<NAME>    absolute address (REG_BASE + REG_OFFSET_<NAME>)
 *   - REG_<NAME>         volatile lvalue of the register's natural width
 *   - field macros use <REG>_<FIELD>_<VALUE> naming; function-like macros
 *     only where pret uses them (REG_TMCNT(n), WIN_RANGE, BGCNT_PRIORITY...)
 *   - all accesses go through vu8/vu16/vu32 lvalues; never cache register
 *     values across accesses
 *
 * src/agb_sram.c depends on REG_WAITCNT; keep its expansion equivalent when
 * editing this file.
 */
...
#define REG_OFFSET_GREENSWAP   0x002
...
#define REG_OFFSET_NR10        0x060
#define REG_OFFSET_SOUND1CNT_H 0x062
#define REG_OFFSET_NR11        0x062
#define REG_OFFSET_NR12        0x063
#define REG_OFFSET_SOUND1CNT_X 0x064
#define REG_OFFSET_NR13        0x064
#define REG_OFFSET_NR14        0x065
#define REG_OFFSET_SOUND2CNT_L 0x068
#define REG_OFFSET_NR21        0x068
#define REG_OFFSET_NR22        0x069
#define REG_OFFSET_SOUND2CNT_H 0x06C
#define REG_OFFSET_NR23        0x06C
#define REG_OFFSET_NR24        0x06D
#define REG_OFFSET_SOUND3CNT_L 0x070
#define REG_OFFSET_NR30        0x070
#define REG_OFFSET_SOUND3CNT_H 0x072
#define REG_OFFSET_NR31        0x072
#define REG_OFFSET_NR32        0x073
#define REG_OFFSET_SOUND3CNT_X 0x074
#define REG_OFFSET_NR33        0x074
#define REG_OFFSET_NR34        0x075
#define REG_OFFSET_SOUND4CNT_L 0x078
#define REG_OFFSET_NR41        0x078
#define REG_OFFSET_NR42        0x079
#define REG_OFFSET_SOUND4CNT_H 0x07C
#define REG_OFFSET_NR43        0x07C
#define REG_OFFSET_NR44        0x07D
#define REG_OFFSET_SOUNDCNT_L  0x080
#define REG_OFFSET_NR50        0x080
#define REG_OFFSET_NR51        0x081
#define REG_OFFSET_SOUNDCNT_H  0x082
#define REG_OFFSET_SOUNDCNT_X  0x084
#define REG_OFFSET_NR52        0x084
#define REG_OFFSET_SOUNDBIAS   0x088
#define REG_OFFSET_SOUNDBIAS_L 0x088
...
#define REG_OFFSET_DMA0SAD_L   0x0B0
#define REG_OFFSET_DMA0SAD_H   0x0B2
#define REG_OFFSET_DMA0DAD     0x0B4
#define REG_OFFSET_DMA0DAD_L   0x0B4
#define REG_OFFSET_DMA0DAD_H   0x0B6
...
#define REG_OFFSET_DMA1SAD_L   0x0BC
#define REG_OFFSET_DMA1SAD_H   0x0BE
#define REG_OFFSET_DMA1DAD     0x0C0
#define REG_OFFSET_DMA1DAD_L   0x0C0
#define REG_OFFSET_DMA1DAD_H   0x0C2
...
#define REG_OFFSET_DMA2SAD_L   0x0C8
#define REG_OFFSET_DMA2SAD_H   0x0CA
#define REG_OFFSET_DMA2DAD     0x0CC
#define REG_OFFSET_DMA2DAD_L   0x0CC
#define REG_OFFSET_DMA2DAD_H   0x0CE
...
#define REG_OFFSET_DMA3SAD_L   0x0D4
#define REG_OFFSET_DMA3SAD_H   0x0D6
#define REG_OFFSET_DMA3DAD     0x0D8
#define REG_OFFSET_DMA3DAD_L   0x0D8
#define REG_OFFSET_DMA3DAD_H   0x0DA
...
#define WAITCNT_SRAM_8          (3 << 0) // bits 0-1: SRAM wait state, 3 = 8 clocks (used by src/agb_sram.c)
...
// Interrupt ID flags (IE/IF bits) live in gba/interrupts.h to keep this
// file a pure register map.
