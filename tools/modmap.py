...
MODULE_NAMES = {
    ...
    0x0809000C: ("enemy/object behaviour bank 6",
                 "121 functions, mean 0x86, 109 pointer-dispatched, 4 anchor tables; 10 task types"),
    ...
    0x080BDA2C: ("sub-game / bonus mode?",
                 "41-entry anchor table @0x08756668 covering 0x080BDAB4-0x080C1B30; reached only from the game-mode flow module; task type #95"),
