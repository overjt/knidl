 ...
 * stores away; their register pressure is still what pushes the ident
 * temporary to r3 in the ROM. */
...
void m4aSoundInit(void)
{
    ...
    CpuCopy32((void *)((s32)SoundMainRAM & ~1), gSoundMainRAM_Buffer,
              sizeof(gSoundMainRAM_Buffer));
...
/* Dead SDK export: BIOS SoundDriverVSyncOn wrapper (swi 0x2A), emitted
 * between MPlayExtender and ClearChain exactly as in the katam SDK. */
...
void SoundInit(struct SoundInfo *soundInfo)
{
    ...
    soundInfo->plynote = (void *)ply_note;
...
void MPlayOpen(struct MusicPlayerInfo *mplayInfo, struct MusicPlayerTrack *tracks, u8 trackCount)
{
    ...
    /* append the music player and priority to the list */
    if (soundInfo->func != 0)
    {
